# Homework 2 - *CoderSchool Chatty*

**CoderSchool chatty** is a Ruby on Rails chat application that allows users to send messages to each other that can only be read once.

Submitted by: **Phuoc Le**
